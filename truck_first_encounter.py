...
def merchant_truck(screen):
	...
	truck_encounter_dialogue_1 = "After a few miles, you come across a truck with a strangely familiar logo on its side and an equally strangely familiar masked occupant in the driver's seat. As you get closer, the back door of the truck opens up and you see a slew of car parts and mechanic's tools. You then notice that the driver, wearing a long, thick leather cloak and purple mask covering most of his face, is now suddenly outside your window."

	truck_encounter_dialogue_2 = "\"Welcome!\", he says in a British accent. \"Got a selection of good things on sale, stranger!\""
	...
	# ═══ IMAGES ════════════════════════════════════════════════════════════════════════════════════════════════════════ #
	# Red Civic in garage
	truck_and_civic_night = pygame.image.load("assets/truck_and_civic_night.png")
	truck_and_civic_night_rect = truck_and_civic_night.get_rect(center=(screen.get_width() // 2, screen.get_height() // 1.45))
	...
	while running:
		...
		screen.blit(truck_and_civic_night, truck_and_civic_night_rect.topleft)
